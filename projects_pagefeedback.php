...
$prjTasks = $fullArray[0]['fields']['Task'];//['records'];
//$prjProjects = $fullArray[0]['fields']['Projects'];
...
<h1 class="visually-hidden">Usability Performance Dashboard</h1>
    ...
    <h2 class="h3 pt-2 pb-2" data-i18n=""><?=$prj?></h2>
    <p data-i18n="" class="page_url hidden"><?=$prj?></p>

    <script type="text/javascript">
          function copy_to_clipboard() {
            navigator.clipboard.writeText('<?=$prj?>');
          }
    ...
    <div class="tabs sticky">
      <ul>
        <li <?php if ($tab=="summary") {echo "class='is-active'";} ?>><a href="./pages_summary.php?prj=<?=$prj?>" data-i18n="tab-summary">Summary</a></li>
        <li <?php if ($tab=="webtraffic") {echo "class='is-active'";} ?>><a href="./pages_webtraffic.php?prj=<?=$prj?>" data-i18n="tab-webtraffic">Web traffic</a></li>
        <li <?php if ($tab=="searchanalytics") {echo "class='is-active'";} ?>><a href="./pages_searchanalytics.php?prj=<?=$prj?>" data-i18n="tab-searchanalytics">Search analytics</a></li>
