                                    ...
                                    <table class="table table-striped dataTable no-footer">
                                      <caption>List of all projects</caption>
                                        ...
                                        <tr>
                                            ...
                                            <th data-i18n="type" scope="col">Type</th>
                                            <th data-i18n="" scope="col">Status</th>
                                            <th data-i18n="" scope="col">Start date</th>
                                            <th data-i18n="" scope="col">Launch date</th>
                                            <th data-i18n="" scope="col">Average test success rate</th>
                                        </tr>
                                        </thead>
                                        <tbody>
