...
class Query
{
    ...
    public function __construct(DriverInterface $driver, int $nestCount = 0) {
    ...
    public function where($column, $valueOrOperator = null, $value = null, string $condition = ' AND '): self
    {
    ...
    public function orWhere($column, $valueOrOperator = null, $value = null): self
    {
    ...
    public function orderBy($column, string $sortMethod = 'ASC'): self
    {
