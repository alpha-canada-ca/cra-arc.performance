...
<div class="back_link"><span class="material-icons align-top">west</span> <a href="./pages_home.php" alt="Back to Pages home page">Pages</a></div>
      ...
      <div class="page_header back_link"><span id="page_project"><span class="material-icons align-top">folder</span> Project </span><span id="view_url"><span class="material-icons align-top">link</span> View URL </span><span id="copy_url" onclick="copy_to_clipboard()"><span class="material-icons align-top">content_copy</span> Copy URL</span></div>
...
?>
    ...
    <div class="row mb-4 mt-1">
      <div class="dropdown">
        ...
        $temp = ['aa-pages-smmry-metrics', 'aa-pages-smmry-fwylf', 'aa-pages-smmry-trnd', 'aa-ovrvw-smmry-tsks', 'prvs', 'activityMap-pages', 'metrics-new-pages', 'activityMap2' ]; //, 'fwylf' ];
        ...
        $ppt = json_decode($result[4], true);
        $previousPages = $ppt["rows"];
        // echo "<pre>";
        // print_r($previousPages);
        // echo "</pre>";
        $activityMap = json_decode($result[5], true);
        ...
        //echo "----------------------<br>";
        $activityMap2 = json_decode($result[7], true);
        //$whatWasClicked = $activityMap["rows"];
        // echo "<pre>";
        // print_r($activityMap2);
        // echo "</pre>";

        $metricsNew = json_decode($result[6], true);
        //$whatWasClicked = $activityMap["rows"];
        // echo "<pre>";
        // print_r($metricsNew);
        // echo "</pre>";
