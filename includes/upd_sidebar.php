        ...
        <div>
          <a class="nav_logo"> <span class="material-icons nav_logo-icon">leaderboard</span> <span class="nav_logo-name">UPD</span> </a>
            <div class="nav_list mt-5">
              ...
              <a href="#" class="nav_link"> <span class="material-icons nav_icon">layers</span> <span class="nav_name" data-i18n="menu-pages">Pages</span> </a>
              <a href="#" class="nav_link"> <span class="material-icons nav_icon">assignment</span> <span class="nav_name" data-i18n="menu-tasks">Tasks</span> </a>
              <a href="#" class="nav_link"> <span class="material-icons nav_icon">folder</span> <span class="nav_name" data-i18n="menu-projects">Projects</span> </a>
               </div>
        </div>
        <div class="mb-4">
