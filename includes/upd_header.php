  ...
  <div class="container vh-100">
    <header id="header">
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-6 col-6 text-end lang-toggle" class="locale-switcher"> <ul class="locale-switcher list-inline">
        <li class="list-inline-item"><a href="#" data-locale="en">English</a></li>
