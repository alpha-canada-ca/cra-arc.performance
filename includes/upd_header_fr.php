  ...
  <div class="container vh-100">
    <header id="header">
      <div class="row">
        ...
        <li class="list-inline-item"><a href="test_en.php" data-locale="en">English</a></li>
        <li class="list-inline-item hidden"><a href="test_fr.php" data-locale="fr">Français</a></li>
